...
font-size: 16px;">  <a href="logout.php" class="btn btn-danger square-btn-adjust"  onclick="return confirm('Apakah yakin ingin keluar?')">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Data Pesanan tempat semua pelanggan</h2>   
    ...
    <?php
          ...
          $query = "SELECT t_masuk.id,t_masuk.nama,t_masuk.no_ktp,t_pelanggan.tempat,t_pelanggan.tanggal,t_pelanggan.waktu,t_pelanggan.konfirmasi FROM t_masuk INNER JOIN t_pelanggan ON t_masuk.id = t_pelanggan.t_masuk_id"; 
