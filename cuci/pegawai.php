...
font-size: 16px;">  <a href="logout.php" class="btn btn-danger square-btn-adjust"  onclick="return confirm('Apakah yakin ingin keluar?')">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                 <hr />
              <!--  <a href="daftarpegawai.php" class="btn btn-danger">TAMBAH PEGAWAI</a> -->
            <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                    <div class="panel panel-default">
                        ...
                        <br><div class="container"><a href="daftarpegawai.php" class="btn btn-danger fa fa-plus fa-1x">TAMBAH PEGAWAI</a></div>
    ...
    <tralign="center">
        ...
        <td>
            ...
            <center>
            <a href="hapuspegawai.php?id=<?php echo $id ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin ingin menghapus <?php echo $nama?>?')">Hapus</a> ||
            <a href="editpegawai.php?id=<?php echo $id ?>" class="btn btn-primary">Edit</a></td>     
