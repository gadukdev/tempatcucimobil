...
font-size: 16px;">  <a href="logout.php" class="btn btn-danger square-btn-adjust"  onclick="return confirm('Apakah yakin ingin keluar?')">Logout</a> </div>
    ...
    <?php
          ...
          require("koneksi.php");
           ...
           $query="SELECT * FROM t_masuk where level ='pelanggan'" ;  
    ...
    <tr align="center">
        ...
        <td>
            ...
            <center>
            <a href="hapususer.php?id=<?php echo $id ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin ingin menghapus <?php echo $nama?>?')">Hapus</a></td>      
